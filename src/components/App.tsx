...
export default function App() {
    ...
    return (
        <main className="relative w-full h-screen overflow-hidden bg-black select-none font-sans">
            ...
            {/* Footer */}
            {/* Footer */}
            <div className="fixed bottom-6 right-8 z-50 pointer-events-none flex flex-col items-end gap-1">
                <div className="flex items-center gap-2 text-[11px] font-medium tracking-[1px] text-white/30 uppercase pointer-events-auto">
                    Made with <span className="text-red-500/60 animate-pulse">❤️</span> by Abhishek
                </div>
                <div className="opacity-20 text-[9px] italic text-white">
